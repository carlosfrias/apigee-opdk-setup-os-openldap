...
> [!NOTE]
> Engineering portfolio note — this project demonstrates enterprise-Linux packaging engineering with a nested-rescue resilience pattern and vendored-RPM fallback. See the [skills assessment →](SKILLS-ASSESSMENT.md) for the expertise applied.
